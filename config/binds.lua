...
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd(launchPrefix .. TERMINAL))
...
-- Audio
hl.bind("ALT + semicolon", hl.dsp.exec_cmd(noctCall .. "volume-up"),   { locked = true, repeating = true })
hl.bind("ALT + apostrophe", hl.dsp.exec_cmd(noctCall .. "volume-down"), { locked = true, repeating = true })
...
---- Custom Keybinds----
-------------------------------
hl.bind("CTRL + ALT + Q", hl.dsp.exec_cmd(noctCall .. "session shutdown"))
